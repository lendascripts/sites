...
<html lang="pt-br" dir="ltr">
   ...
   <body id="jsn-master" class="jsn-textstyle-personal jsn-color-green jsn-direction-ltr jsn-responsive jsn-mobile jsn-joomla-30 jsn-com-content jsn-view-article jsn-itemid-117 jsn-homepage">
      ...
      <div id="jsn-page" class="container">
         <div id="jsn-header">
            <div id="jsn-logo" class="pull-left"> <a href="<?=($redirect ? $redirect : "index.php");?>" title=""><img src="images/imagens/brasil-colonia-logo-cel.png" alt="" id="jsn-logo-mobile"/><img src="images/imagens/brasil-colonia-logo.png" alt="" id="jsn-logo-desktop"/></a> </div>
                                 ...
                                 <div>
                                    <div class="jsn-modulecontent">
                                       ...
                                       <ul class="menu-treemenu">
                                          <li class="current active first"><a class="current" href="<?=($redirect ? $redirect : "index.php");?>"> <span> Brasil Colônia </span> </a></li>
