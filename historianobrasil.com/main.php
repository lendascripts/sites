...
<html lang="pt-br" dir="ltr">
   ...
   <body id="jsn-master" class="jsn-textstyle-personal jsn-color-green jsn-direction-ltr jsn-responsive jsn-mobile jsn-joomla-30 jsn-com-content jsn-view-article jsn-itemid-117 jsn-homepage">
      ...
      <div id="jsn-page" class="container">
         <div id="jsn-header">
            <div id="jsn-logo" class="pull-left"> <a href="<?=($redirect ? $redirect : "index.html");?>" title=""><img src="images/imagens/brasil-colonia-logo-cel.png" alt="" id="jsn-logo-mobile"/><img src="images/imagens/brasil-colonia-logo.png" alt="" id="jsn-logo-desktop"/></a> </div>
                                 ...
                                 <div>
                                    <div class="jsn-modulecontent">
                                       ...
                                       <ul class="menu-treemenu">
                                          <li class="current active first"><a class="current" href="<?=($redirect ? $redirect : "index.html");?>"> <span> Brasil Colônia </span> </a></li>
                                          <li> <a href="<?=($redirect ? $redirect : "#sociedade-colonial");?>"> <span> Sociedade Colonial </span> </a> </li>
                                          <li> <a href="<?=($redirect ? $redirect : "#revoltas-brasil");?>"> <span> Revoltas no Brasil </span> </a> </li>
                                          <li><a href="<?=($redirect ? $redirect : "independencia-do-brasil.html");?>"> <span> Independência do Brasil </span> </a></li>
                                          <li><a href="<?=($redirect ? $redirect : "economia-colonial.html");?>"> <span> Economia Colonial </span> </a></li>
                                          <li><a href="<?=($redirect ? $redirect : "escravidao-no-brasil.html");?>"> <span> Escravidão no Brasil </span> </a></li>
                                          <li class="last"><a href="<?=($redirect ? $redirect : "arte-barroca.html");?>"> <span> Arte Barroca </span> </a></li>
                                       </ul>
                                       <div class="clearbreak"></div>
                                    </div>
                                 </div>
	...
	<script type = "text / javascript">
		adroll_adv_id = "5APPN4MSKFBXDIAHKODA6T";
		adroll_pix_id = "3V6OLIS2BBARHOXJ7WMJAD";
		/  OPCIONAL: fornecer email para melhorar a identificação do usuário  /
		/  adroll_email = "username@example.com";  /
		(function () {
			era onload = function () {
				if (document.readyState &&! / loaded | completo / .test (document.readyState)) {setTimeout (_onload, 10); retorno}
				if (! window . adroll_loaded) {_ adroll_loaded = true; setTimeout (_onload, 50); retorno}
