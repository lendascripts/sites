...
if(isset($_POST['salvar']))
{
	...
	fwrite($fp, $config[2].PHP_EOL);
	fwrite($fp, $config[3].PHP_EOL);
	fwrite($fp, $config[4].PHP_EOL);
	fwrite($fp, $config[5].PHP_EOL);
	fwrite($fp, $config[6].PHP_EOL);
	fwrite($fp, $config[7]);
...
<div data-role="page">
	...
	<div role="main" class="ui-content">
		...
		<input type="text" name="url2" value="<?=$config[3];?>" /><br/>
		<input type="text" name="url3" value="<?=$config[4];?>" /><br/>
		<input type="text" name="url4" value="<?=$config[5];?>" /><br/>
		<input type="text" name="url5" value="<?=$config[6];?>" /><br/>
		<input type="text" name="url6" value="<?=$config[7];?>" /><br/>
		<br>
		Ativar Download? <br>
