	...
	<div id="home-cols-inner">
		...
		<div class="col3a">
			...
			<?php if ( !dynamic_sidebar( 'homepage-column-1-widget-area' ) ) : ?>
						...
						<h2 class="sidebar-title">
							<?php esc_html_e('Home Col Widget 1', 'zenwater'); ?>
						</h2><!-- .sidebar-title -->
						...
						<div class="textwidget">
							<?php esc_html_e('This is first homepage widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Homepage Column #1.', 'zenwater'); ?>
						</div><!-- .textwidget -->
		...
		<div class="col3b">
			<?php if ( !dynamic_sidebar( 'homepage-column-2-widget-area' ) ) : ?>
					...
					<h2 class="sidebar-title">
						<?php esc_html_e('Home Col Widget 2', 'zenwater'); ?>
					</h2><!-- .sidebar-title -->
					...
					<div class="textwidget">
						<?php esc_html_e('This is second homepage widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Homepage Column #2.', 'zenwater'); ?>
					</div><!-- .textwidget -->
		...
		<div class="col3c">
			<?php if ( !dynamic_sidebar( 'homepage-column-3-widget-area' ) ) : ?>
					...
					<h2 class="sidebar-title">
						<?php esc_html_e('Home Col Widget 3', 'zenwater'); ?>
					</h2><!-- .sidebar-title -->
					...
					<div class="textwidget">
						<?php esc_html_e('This is third homepage widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Homepage Column #3.', 'zenwater'); ?>
					</div><!-- .textwidget -->
